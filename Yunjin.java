...
public class Yunjin {            
   ...
   private Image playerImage, playerLeftImage, playerRightImage, playerstopImage, playerhurtImage, playerattackImage;
   ...
   public Yunjin (JPanel panel, TileMap t, BackgroundManager b) {
      this.panel = panel;
      y=320;
      ...
      playerRightImage = ImageManager.loadImage("images/yRight1.gif");
      playerLeftImage = ImageManager.loadImage("images/yLeft1.gif");
      playerstopImage = ImageManager.loadImage("images/ystop1.gif");
      playerhurtImage = ImageManager.loadImage("images/ydie1.gif");
      playerattackImage = ImageManager.loadImage("images/yattack1.gif");
      playerImage = playerstopImage;
